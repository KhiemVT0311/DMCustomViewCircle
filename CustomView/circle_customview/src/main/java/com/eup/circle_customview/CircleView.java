...
public class CircleView extends View implements CircleInterface, ViewPager.OnPageChangeListener {
    ...
    private void initDot(int count) throws PagesLessException {
        ...
        dots = new DotCircle[count];
        for (int i = 0; i < dots.length; i++) {
            dots[i] = new DotCircle();
        }
    }
